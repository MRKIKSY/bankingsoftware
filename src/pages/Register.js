    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-100 px-4">
      <div className="bg-white p-6 rounded-xl shadow-md w-full max-w-md">
        ...
        <form onSubmit={handleRegister} className="space-y-4">
          ...
          <input type="text" placeholder="Signup Code" value={signupCode}
            onChange={(e) => setSignupCode(e.target.value)} required
            className="w-full p-2 border rounded" />

          <input type="text" placeholder="Bank Account Name & Number"
            value={accountDetails}
            onChange={(e) => setAccountDetails(e.target.value)} required
            className="w-full p-2 border rounded" />
